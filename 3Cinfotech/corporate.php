    ...
    height: 290px;">
                ...
                <div class="block-highlight block-pd-h block-pd-sm" style="margin-top: 30px;">
                    <div class="gac_grid" style="width:92%;">
                          <div class="box">
                              <div class="top1">
                                <a href="javascript:void"><i class="fa fa-plus-circle" aria-hidden="true" style="color:orange; float:right;display: inline-block;font: normal normal normal 14px/1 FontAwesome;font-size: 29px;text-rendering: auto;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;right: 45px;margin-top: -25px;
